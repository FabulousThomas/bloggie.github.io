  ...
  <header class="main-header bg-dark bg-lg">
    ...
    <nav class="main-nav">
      <ul class="main-nav__item">
        <li class="main-nav__items"><a href="index.php">home</a></li>
      ...
      <div class="row">
        <div class="col-md-8">
          <?php foreach($query as $q) {?>
            <i class="fa fa-user"> <?php echo $q['author'];?></i> &nbsp;
            <i class="fa fa-calendar"> <?php echo $q['created_at'];?></i>
            <h2 class="pb-3"><?php echo $q['title'];?></h2>
